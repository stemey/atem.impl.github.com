	...
	DynamicEntityTypeSubrepository<DynamicEntity>, EntityTypeBuilderCallback
{
	...
	{
		DynamicEntityTypeBuilder entityTypeBuilder = beanLocator.getInstance(DynamicEntityTypeBuilder.class);
	...
	{
		final DynamicEntityTypeImpl dynamicEntityTypeImpl = beanLocator.getInstance(DynamicEntityTypeImpl.class);
