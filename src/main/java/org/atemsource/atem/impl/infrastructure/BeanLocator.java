...
import org.atemsource.atem.api.meta.BeanReferenceData;
import org.atemsource.atem.api.meta.BeanReferenceData.BeanReference;
...
public class BeanLocator implements BeanFactoryPostProcessor
{
	/**
	...
	{
		if (bean.containingScope != null)
		{
			bean.containingScope.remove(bean.getBeanName());
		}
	}
}
